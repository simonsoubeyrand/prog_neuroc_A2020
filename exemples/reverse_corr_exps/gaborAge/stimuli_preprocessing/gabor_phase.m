...
classdef gabor_phase %#codegen
    ...
    methods
        ...
        function self = gabor_phase(varargin)
            
            if (nargin > 0)
                results = parseInputs(varargin{1:2});
                ...
                % instances.
                self(numFilters) = gabor_phase(); %#ok<*EMVDF>
                for n = 1:numFilters
